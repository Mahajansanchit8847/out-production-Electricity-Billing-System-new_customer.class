...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            area.setText("\tReliance Power Limited\nELECTRUCITY BILL GENERATE FOR THE MONTH\n\tOF  "+month+", 2024\n\n\n");
            ...
            if (rs.next()){
            area.append("\n   Meyter Location :   "+ rs.getString("meter_location"));
            ...
            //area.append("\n   Old Reading :       "+ rs.getString("OldReading"));
            //area.append("\n   New Reading :       "+ rs.getString("NewReading"));
            area.append("\n   Units Consumed :        "+ rs.getString("units"));
            area.append("\n   Total Charge:      "+ rs.getString("totalbill"));
            area.append("\n-------------------------------------------------- ");
            area.append("\n   Total Paybill:      "+ rs.getString("totalbill"));
            area.append("\n");
        }
        }catch(Exception e){
            e.printStackTrace();
