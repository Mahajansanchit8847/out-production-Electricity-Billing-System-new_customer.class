...
public class Login extends JFrame  implements ActionListener{
    ...
    Login(){
        ...
        JLabel loggininas = new JLabel("loggi ni as");  
        ...
        login.setBounds(310,160,100,20);
        ...
        cancle.setBounds(440,160,100,20);
        ...
        signup.setBounds(370,200,100,20);
        ...
        if(ae.getSource()==login){
            ...
            try {
                ...
                if (rs.next()){ 
                    ...
                    String meter=rs.getString("meater_no");
                  setVisible(false);
