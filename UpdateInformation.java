...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    JTextField tfaddress , tfstate, tfemail,tfcity,tfphone ;
...
//                      
      ...
      public void actionPerformed (ActionEvent ae){
        if (ae.getSource() == update){
            ...
            try {
                Conn c = new Conn ();
                c.s.executeUpdate("update customer set address='"+address+"','"+state+"','"+city+"','"+email+"','"+phone+"',where meter_no= '"+meter+"' ");
                
                JOptionPane.showMessageDialog(null, "user infomation Update Successfully ");
                setVisible(false);
