    ...
    Signup(){
        ...
        @Override
            ...
            public void focusLost (FocusEvent fe){
                try{
                    Conn c = new Conn (); 
ResultSet rs = c.s.executeQuery("select * from login where meater_no = '"+meter.getText()+"'");
                    while (rs.next()){
        ...
        Image i2= i1.getImage().getScaledInstance(255,255,Image.SCALE_DEFAULT);
        ...
        if(ae.getSource()==create){
            ...
            try{
                ...
                if (atype.equals("Admin")){
                    ...
                    query = " update login set username ='"+susername+"', password ='"+spassword+"', user='"+atype+"' where meater_no='"+smeter+"'";
                }
